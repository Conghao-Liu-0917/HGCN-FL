...
class Client_Net(nn.Module):
    ...
    def local_train(self, local_epoch):
        ...
        train_stats = train_client(self.model, self.dataLoader, self.optimizer, local_epoch, self.args.device)
...
def train_client(model, dataloaders, optimizer, local_epoch, device):
